...
export const register = async (req, res) => {
    try {
        ...
        if (isCloudinaryConfigured) {
            ...
            if (file) {
                console.warn("Cloudinary not configured. Skipping file upload and using fallback profile photo.");
            }
        }
...
export const updateProfile = async (req, res) => {
    try {
        ...
        } else if (file && !isCloudinaryConfigured) {
            console.warn("Cloudinary not configured. Skipping resume upload.");
        }
