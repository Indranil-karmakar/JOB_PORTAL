      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-[#6A38C2] transition-colors duration-300" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-[#6A38C2] transition-colors duration-300" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-[#6A38C2] transition-colors duration-300" aria-label="LinkedIn">
