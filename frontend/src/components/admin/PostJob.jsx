...
const PostJob = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (!input.title || !input.description || !input.requirements || !input.location || !input.jobType || !input.companyId) {
            toast.error("Please fill in all fields and select a company.");
            return;
        }
        if (Number.isNaN(salaryValue) || Number.isNaN(experienceValue) || Number.isNaN(positionValue)) {
